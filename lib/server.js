...
module.exports = (directory, format, width, height, fps, horizontalFlip, verticalFlip, listSize, storageSize, port) => {
  ...
  const raspividOptions = ['-o', '-', '-t', '0', '-w', width, '-h', height, '-fps', fps];
